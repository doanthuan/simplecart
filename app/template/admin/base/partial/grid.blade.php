@section('head')
@parent
<script src="{{url('media/system/js/grid.js')}}"></script>
@stop
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr>
                <?php foreach($columns as $column ){
                    ...
                    {?>
                        <th width="50px"><input type="checkbox" name="toggle" value="" onclick="checkAll('<?php echo count($items);?>');" id="cbCheckAll"/></th>
                    <?php
                    }
                    ...
                    <th class="<?php echo $class;?>" width="<?php echo $width;?>">
                        ...
                        ?></th>
                <?php } ?>
                <th class="col-md-1"><a href="#">{{trans('Action')}}</a></th>
            </tr>
            </thead>
            <!-- header end -->
                ...
                foreach ($items as $i => $item) {?>
                    <tr>
                        <?php foreach($columns as $column ){
                            if(isset($column['key']) && $column['key'] == true)
                            {
                                echo '<td>'.'<input type="checkbox" id="cb' . $i . '" name="cid[]" value="' . $item[$column['name']]. '"  />'.'</td>' ;
                            }
                        ...
                        <td><?php echo $grid->getActionLinks($item)?></td>
                    </tr>
                <?php }
            }
            ?>
